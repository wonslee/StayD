...
public class ReviewListController implements Initializable {
    ...
    @FXML
    private Label averageRatingLabel;           // 평균 평점 표시용 라벨
    @FXML
    private ListView<ReviewListDTO> reviewListView; // 리뷰 목록 리스트뷰
    ...
    /**
     * 외부에서 카페 ID를 주입받을 때 사용하는 메서드 - cafeId가 설정되면 리뷰 목록을 로딩함
     */
