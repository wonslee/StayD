...
public class UserDTO {
    ...
    /**
     * 사용자 ID 사용자 정보의 고유 식별자입니다.
     */
    private int user_id;

    /**
     * 로그인 아이디 아이디는 비어 있을 수 없으며, 유효한 아이디 형식이 필요합니다.
     */
    ...
    /**
     * 비밀번호 비밀번호는 최소 8자 이상이어야 하며, 영문, 숫자, 특수문자를 포함해야 합니다.
     */
    ...
    /**
     * 비밀번호 확인 비밀번호를 재입력받고, 일치 여부를 확인합니다.
     */
    @NotBlank(message = "동일한 비밀번호를 입력해주세요.")
    private String passwordCheck;

    /**
     * 사용자 역할 사용자에게 부여된 역할을 나타냅니다. 예: "USER", "CAFE_OWNER" 등
     */
